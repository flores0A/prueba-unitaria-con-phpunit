<?php session_start();
$url_base = "http://localhost/pruebas/public/";
if (!isset($_SESSION['usuario'])) {
    header("Location:" . $url_base . "Iniciarsesion.php");
}
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark navbar-expand navbar-light bg-light">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $url_base; ?>../src/cerrar.php">cerrar session</a>
            </li>
        </ul>
